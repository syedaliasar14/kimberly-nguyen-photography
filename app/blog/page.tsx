    ...
    <section className="py-20 min-h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="font-serif text-4xl sm:text-5xl text-primary mb-6 font-bold tracking-tight">
            Blog
          </h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto font-accent">
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-xs text-accent font-accent font-medium uppercase">
                    {post.category}
                  </span>
                  <span className="text-xs text-muted-foreground font-accent">•</span>
                  <span className="text-xs text-muted-foreground font-accent">{post.date}</span>
                </div>
                <h2 className="font-serif text-xl text-primary mb-3 font-semibold">
                  {post.title}
                </h2>
                <p className="text-muted-foreground leading-relaxed mb-4 font-accent">
                  {post.excerpt}
                </p>
                <button 
                  className="text-primary hover:text-accent transition-colors font-accent font-medium"
                  disabled
                >
                  Read More →
                </button>
        ...
        <div className="mt-16 text-center">
          <div className="bg-secondary rounded-lg p-8">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto font-accent">
