    ...
    <section className="py-20 min-h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="font-serif text-4xl sm:text-5xl text-forest mb-6">
            Blog
          </h1>
          ...
          {placeholderPosts.map((post) => (
            ...
            >
              <div className="aspect-[4/3] bg-sage/10 flex items-center justify-center">
                <p className="text-sage">Blog Post Image</p>
              </div>
              <div className="p-6">
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-xs text-sage font-medium uppercase">
                    {post.category}
                  </span>
