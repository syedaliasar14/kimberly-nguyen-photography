...
import { Playfair_Display, Inter, DM_Serif_Display, Jost, Lavishly_Yours, Dancing_Script } from "next/font/google";
...
const dancingScript = Dancing_Script({ variable: "--dancing-script", subsets: ["latin"], weight: ["400", "500", "600", "700"] });

export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="en">
      <body className={`${playfairDisplay.variable} ${inter.variable} ${dmSerifDisplay.variable} ${jost.variable} ${dancingScript.variable} antialiased`}>
        <Header />
