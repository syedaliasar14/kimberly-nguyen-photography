  ...
  return (
    <section className="py-32 bg-white relative overflow-hidden">
      ...
      <Image
        ...
        fill priority
        className="object-cover object-center absolute inset-0 opacity-10 w-full absolute scale-105"
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col md:flex-row gap-12 items-center">
        ...
        <div className="space-y-6 md:w-2/3 w-full">
          ...
          <div className="text-xl md:text-2xl text-primary whitespace-pre-wrap text-justify">
          ...
          <div className="pt-4 text-center md:text-left">
            <Link href="/contact" className="btn text-white hover:bg-white hover:text-primary inline-block">
