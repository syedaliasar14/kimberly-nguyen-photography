      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
          <div className="text-center">
            ...
            <h3 className="font-serif text-xl text-primary mb-4">Flow</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="font-serif text-xl text-primary mb-4">Balance</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="text-center">
            ...
            <h3 className="font-serif text-xl text-primary mb-4">Heart</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="text-center">
            ...
            <h3 className="font-serif text-xl text-primary mb-4">Cohesive Aesthetics</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="text-center">
            ...
            <h3 className="font-serif text-xl text-primary mb-4">Diversity</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="text-center">
            ...
            <h3 className="font-serif text-xl text-primary mb-4">Community</h3>
            <p className="text-muted-foreground leading-relaxed">
