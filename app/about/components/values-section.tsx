      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
          <div className="text-center group hover:scale-105 transition-transform">
            ...
            <h3 className="font-heading text-xl text-primary mb-4 font-semibold">Flow</h3>
          ...
          <div className="text-center group hover:scale-105 transition-transform">
            ...
            <h3 className="font-heading text-xl text-primary mb-4 font-semibold">Balance</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="text-center group hover:scale-105 transition-transform">
            ...
            <h3 className="font-heading text-xl text-primary mb-4 font-semibold">Heart</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="text-center group hover:scale-105 transition-transform">
            ...
            <h3 className="font-heading text-xl text-primary mb-4 font-semibold">Cohesive Aesthetics</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="text-center group hover:scale-105 transition-transform">
            ...
            <h3 className="font-heading text-xl text-primary mb-4 font-semibold">Diversity</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="text-center group hover:scale-105 transition-transform">
            ...
            <h3 className="font-heading text-xl text-primary mb-4 font-semibold">Community</h3>
            <p className="text-muted-foreground leading-relaxed">
