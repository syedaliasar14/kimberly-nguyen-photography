        ...
        <div className="max-w-md w-full mx-4">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-primary text-cream px-8 py-3 rounded-full hover:bg-accent transition-colors text-lg font-medium"
              >
                Access Admin Panel
              </button>
            </form>
    ...
    <section className="py-20 min-h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <button
          ...
          className="bg-muted text-cream px-6 py-2 rounded-full hover:bg-primary transition-colors"
        >
          Logout
        </button>
      </div>
